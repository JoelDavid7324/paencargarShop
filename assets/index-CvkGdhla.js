      ...
      e: for (var W = 0, G = _.length, bt = G >>> 1; W < bt; ) {
        ...
        if (0 > l(gl, j))
          gn < G && 0 > l(er, gl)
            ? ((_[W] = er), (_[gn] = j), (W = gn))
            : ((_[W] = gl), (_[yn] = j), (W = yn));
        else if (gn < G && 0 > l(er, j)) (_[W] = er), (_[gn] = j), (W = gn);
        else break e;
      }
    }
    return z;
      ...
      return (
        ...
        j > W
          ? ((_.sortIndex = j),
            ...
            t(s) === null &&
              _ === t(c) &&
              (k ? (f(P), (P = -1)) : (k = !0), yl(y, j - W)))
          : ((_.sortIndex = G), n(s, _), v || S || ((v = !0), vl(E))),
        _
      );
    }),
  ...
  Ss(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y),
              f !== null && ((y = Rt(a, f)), y != null && k.push(At(a, y, d)))),
            R)
          )
            break;
          a = a.return;
        ...
        0 < k.length &&
          ((p = new S(p, v, null, t, m)), h.push({ event: p, listeners: k }));
      }
    }
    if (!(n & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (R = S == null ? p : $n(S)),
            (d = v == null ? p : $n(v)),
            (p = new k(y, a + "leave", S, t, m)),
            (p.target = R),
            (p.relatedTarget = d),
            (y = null),
            kn(m) === c &&
              ((k = new k(f, a + "enter", v, t, m)),
              (k.target = d),
              (k.relatedTarget = R),
              (y = k)),
            (R = y),
            ...
            n: {
              for (k = S, f = v, a = 0, d = k; d; d = Rn(d)) a++;
...
function ra(e) {
  ...
  function p(f, a, d, y) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (wt(d) || ct(d)) return E !== null ? null : m(f, a, d, y, null);
      pr(f, d);
    }
    return null;
  }
  function S(f, a, d, y, E) {
    ...
    if (typeof y == "object" && y !== null) {
      switch (y.$$typeof) {
        ...
        case Je:
          var C = y._init;
          return S(f, a, d, C(y._payload), E);
      }
      if (wt(y) || ct(y)) return (f = f.get(d) || null), m(a, f, y, E, null);
      pr(a, y);
    }
    return null;
  }
    ...
    if (
      ...
      switch (d.$$typeof) {
        ...
        case On:
          ...
          return o(f);
        case Je:
          return (C = d._init), R(f, a, C(d._payload), y);
      }
      if (wt(d)) return v(f, a, d, y);
        ...
        e: {
          ...
          switch (((p = n), (S = t), k.tag)) {
            ...
            case 0:
              if (
                ((v = k.payload),
                (p = typeof v == "function" ? v.call(S, h, p) : v),
                p == null)
              )
                break e;
              h = V({}, h, p);
...
function ju(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    ...
    u !== h || p !== v || fe.current || qe
      ? (typeof S == "function" && (xi(n, t, S, r), (v = n.memoizedState)),
        (c = qe || xu(n, t, c, r, p, v, s) || !1)
          ? (m ||
...
function cd(e, n, t) {
  ...
  switch ((io(n), n.tag)) {
    ...
    case 4:
      return (
        tt(), ji(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null
      );
    case 10:
...
function Me(e, n, t, r) {
  if (50 < Lt) throw ((Lt = 0), (Di = null), Error(g(185)));
  Gt(e, t, r),
    (!(M & 2) || e !== J) &&
...
function Ln(e) {
  ...
  try {
    ...
    (O = r), (Ee.transition = t), (M = n), !(M & 6) && vn();
  }
}
function No() {
  (me = Qn.current), F(Qn);
...
function Po() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    J === null || (!(jn & 268435455) && !(cl & 268435455)) || en(J, b);
}
function qr(e, n) {
  var t = M;
  M |= 2;
  ...
  while (!0);
  if ((so(), (M = t), (Gr.current = r), K !== null)) throw Error(g(261));
  return (J = null), (b = 0), X;
}
function yd() {
  for (; K !== null; ) Ya(K);
...
gs = Co;
ws = Ln;
var jd = { usingClientEntryPoint: !1, Events: [Jt, $n, il, vs, ys, Co] },
  yt = {
...
const Hu = ["./assets/watch.svg", "./assets/shopping-cart.svg"],
          ...
          children: w.jsxs("div", {
            ...
            children: [
              ...
              w.jsx("button", {
                onClick: () => {
                  if (e.length > 0) {
                    const s = `Hola, me gustaría saber más sobre el ${e
                      .map(
                        (c) =>
                          `${c.title + " " + c.description} (x${c.quantity})`
                      )
                      .join(", ")}`;
                    window.open(`https://wa.me/+5358468600?text=${s}`);
                  }
                },
    ...
    w.jsxs("div", {
      ...
      children: [
        ...
        w.jsx("figure", {
          ...
          children: w.jsx("img", { src: "./assets/glass.svg", alt: "glass" }),
        }),
      ],
    }),
  Od = ({
    ...
    const m = (v) => {
        const k = e.find((R) => R.id === v.id);
        if (k) {
          const R = { ...k, quantity: k.quantity + 1 };
          n(e.map((f) => (f.id === v.id ? R : f))), r(t + 1);
        } else n([...e, { ...v, quantity: 1 }]), r(t + 1);
      },
      h = (v) => {
        const k = `Hola, me gustaría saber más sobre el ${
          v.title + " " + v.description
        }`;
        window.open(`https://wa.me/+58468600?text=${k}`);
      },
      p = (v) => {
        c(v.image);
      },
              ...
              "div",
              {
                ...
                children: [
                  w.jsx("figure", {
                    ...
                    onClick: () => p(v),
                    children: w.jsx("img", {
                      src: `https://paencargar.com/cell/${v.image}`,
                      alt: v.title,
                    }),
                  }),
                  w.jsxs("div", {
                    ...
                    children: [
                      w.jsx("div", {
                        ...
                        children: w.jsx("h3", {
                          children: v.title + " " + v.description,
                        }),
                      }),
                      w.jsxs("p", {
                        children: [
                          "USD: ",
                          w.jsx("span", { children: v.price }),
                        ],
                      }),
                      w.jsxs("p", {
                        children: ["MLC: ", w.jsx("span", { children: v.mlc })],
                      }),
                    ],
                  }),
                  w.jsxs("div", {
  ...
  Dd = (e) =>
    w.jsx("div", { className: "general__container", children: e.children });
function Id() {
...
Ql.createRoot(document.getElementById("root")).render(
  w.jsx(wc.StrictMode, { children: w.jsx(Id, {}) })
);
